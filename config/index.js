export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxee9d5f91bb7ac049",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "533dbda92918f3f7cabb4ec75ea2b234",
  ...
  USERS: [
    {
      ...
      id: "o2fF-6QhTL_6GFmtphaNeOoboQjQ",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "rTkJ7vuf4DQK0QcIHTZd_CpQCFmx9DvCJtIvZ_QKMnI",
      // 所在省份
      province: "山西",
      // 所在城市
      city: "大同",
  ...
  CALLBACK_TEMPLATE_ID: "	rTkJ7vuf4DQK0QcIHTZd_CpQCFmx9DvCJtIvZ_QKMnI	",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "o2fF-6Sp_87Z-NMqOyTPHMtUUAdg",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
